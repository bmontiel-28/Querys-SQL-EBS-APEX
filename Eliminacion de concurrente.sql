...
BEGIN
    L_PROG_SHORT_NAME := 'HCS_CARMONA_HIWORLDD';
    L_EXEC_SHORT_NAME := 'HCS_CARMONA_HIWORLDD';
    L_APPL_SHORT_NAME := 'FND';
    L_APPL_FULL_NAME := 'Application Object Library';
    ...
    BEGIN
        ...
        ELSE
            DBMS_OUTPUT.PUT_LINE('NO EXISTE EXECUTABLE: ' || L_EXEC_SHORT_NAME);
        END IF;
    EXCEPTION
        WHEN OTHERS THEN
            DBMS_OUTPUT.PUT_LINE('ERROR AL ELIMINAR: ' || SQLERRM);
