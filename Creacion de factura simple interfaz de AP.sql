/* Tablas de interface */
TRUNCATE TABLE AP.AP_INVOICES_INTERFACE;
TRUNCATE TABLE AP.AP_INVOICE_LINES_INTERFACE;
DELETE FROM AP_INTERFACE_REJECTIONS
WHERE
    TO_CHAR(CREATION_DATE,'DD/MM/YYYY') = TO_CHAR(SYSDATE,'DD/MM/YYYY');
COMMIT;


/* Bloque de creacion de API */
DECLARE
